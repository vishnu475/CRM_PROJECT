...
export const AccountsPage: React.FC = () => {
  const { accounts, activeSubSection, setActiveSubSection } = useApp();

  // Navigation Tabs
  const validAccountsTabs = ['coa', 'vouchers', 'ar_ap'];
  const mainTab = (validAccountsTabs.includes(activeSubSection) ? activeSubSection : 'coa') as 'coa' | 'vouchers' | 'ar_ap';
  const setMainTab = (tab: 'coa' | 'vouchers' | 'ar_ap') => setActiveSubSection(tab);
